...
for(i=0; i<=2; i++){
    if(productUser === 1){
    if(typeProductUser2 === "botellas" || typeProductUser2 === "termos" || typeProductUser2 === "herramientas"){
        alert(`Usted ha seleccionado ${typeProductUser2}.`);
        break;
    }    
    else{
...
if (productUser === 1) {
    ...
    if (segundoProducto === "si") {
        ...
        //alert(`Usted ha elegido: ${sumarProductos(productUserCantidad, productUserCantidad2)} productos; ${productUserCantidad} ${typeProductUser} y ${productUserCantidad2} ${typeProductUser2}.`);
        ...
        alert(`El total es de ${multiplicarProductos(resultadoSumarProductos, precioLineaStanley)} pesos.`);
    } else {
        ...
        //alert(`El total es de ${multiplicarProducto(productUserCantidad, precioLineaStanley)} pesos.`);
...
let resultadoSumarProductos = sumarProductos(productUserCantidad, productUserCantidad2);
alert(`Usted ha elegido: ${sumarProductos(productUserCantidad, productUserCantidad2)} productos; ${productUserCantidad} ${typeProductUser} y ${productUserCantidad2} ${typeProductUser2}.`);
